                      ...
                      <div>
                      {
                            ...
                            ?
                                <div>
                                    ...
                                    <hr/>
                                    <table className="table  myStyle-main9 table-bordered table-striped">
                                        <thead>
                                        <tr>
                                            <th className={'tableHead'}>Group Id</th>
                                    ...
                                    {this.props.groupNames.map(tile => (
                                        ...
                                        <tr className="imageGridStyle " key={tile.groupId}>

                                            <td className="tableData"
                                               alt={'myimage'}>
                                                <img alt="myImg" src={Icon}/>{tile.groupId}</td>
                                            ...
                                            <td className="tableData"
                                               ...
                                               alt={'myimage'}>
                                                {tile.group_name}  (Click to find members)</td>
                                        </tr>
                                    ))}
                                        </tbody>
                                    </table>
                        ...
                        <div>
                            ...
                            ?
                                ...
                                <div>
                                    <h5 className="myStyle-main2">Group Members</h5>
                                    <hr/>
                                    <table className="table  myStyle-main9 table-bordered table-striped">
                                        <thead>
                                        <tr>
                                            <th className={'tableHead'}>Member Name</th>
                                            <th className={'tableHead'}>Member Email ID</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        {this.state.groupMemberNames.map(tile => (

                                            <tr className="imageGridStyle " key={tile.email}>

                                                <td className="tableData"
                                                    alt={'myimage'}>
                                                    {tile.firstName} &nbsp; {tile.lastName}</td>
                            ...
                            this.state.images.map(tile => (
                                ...
                                <div className="imageGridStyle toggleVisibility" key={tile} cols={tile || 1}>
                                    ...
                                    <a className="myStyle-main3" href={'http://localhost:3001/' + tile}
                                       ...
                                       :  <img alt="myImg" src={newfolderIcon} style={{height:"30px"}}/>}
                                        {tile}</a>
                                ...
                                <div className="maestro-nav__contents">
                                    <ul className="maestro-nav__products">
                                        ...
                                        <a>
                                            ...
                                            <li data-reactid="25">
                                                <br/><span onClick={() => {
                                                prompt('Please enter name of the group');
                                            }}><img alt="myImg" src={Icon}/> Create Group</span>
                                            </li>
                                            <li data-reactid="25">
                                                <br/><span onClick={() => {
                                                prompt('Enter Emails to add in group');
